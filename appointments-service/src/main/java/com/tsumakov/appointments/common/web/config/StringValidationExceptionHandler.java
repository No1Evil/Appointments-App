...
@Produces
@Component
public final class StringValidationExceptionHandler
    implements ExceptionHandler<StringValidationException, HttpResponse<?>> {

  @Override
  public HttpResponse<?> handle(HttpRequest request, StringValidationException exception) {
